<script>
  ...
  const jsonchema = '{"datetime": {"type": "datetime"},"event": {"type": "values_weighted","params": {"values": ["view","cart","sale"],"weights": [60,33,24]}},"product": {"type": "values","params": {"values": ["sZzx0cUDX98","5d0cgAl5BTk","YY4YaHKh2jQ","p8Drpg_duLw","xFmXLq_KJxg","fSdBxY0NxVI","6cHumpSxTvs","Zu7A1GCSjZE","Fg15LdqpWrs"]}}}'
