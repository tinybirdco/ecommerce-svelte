...
export default function KpiCardGrid() {
  ...
  const handleInputhoursParamChange = (event: {
    ...
    <>
      ...
      <main className="bg-slate-50 p-6 sm:p-10">
        ...
        <Text marginTop="mt-1">
          Analytics for the{" "}
          <Bold>
            <a href="https://ecommerce-svelte-rho.vercel.app/">
        ...
        >
          ...
          <Block>
            ...
            >
              ...
              <DropdownItem value="short sleeve" text="Short sleeve" />
              <DropdownItem value="long sleeve" text="Long sleeve" />
            </Dropdown>
          </Block>
          ...
          <>
            ...
            >
              ...
              <KpiCard
                ...
                metric={
                  kpiData
                    ? Intl.NumberFormat("us").format(kpiData[0].cart_value)
                    : "0"
                }
              ></KpiCard>
              <KpiCard
                ...
                metric={
                  kpiData
                    ? Intl.NumberFormat("us").format(kpiData[0].revenue)
                    : "0"
                }
              ></KpiCard>
              <KpiCard
                ...
                metric={
                  kpiData
                    ? Intl.NumberFormat("us").format(kpiData[0].conversion)
                    : "0"
                }
              ></KpiCard>
            </ColGrid>
          ...
          <Block>
            <Block marginTop="mt-3">
              ...
              <Dropdown
                ...
                maxWidth="max-w-xs"
              >
                <DropdownItem value="sales" text="Sales" />
                <DropdownItem value="carts" text="Carts" />
                <DropdownItem value="views" text="Views" />
              </Dropdown>
            </Block>
